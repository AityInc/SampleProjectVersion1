...
const CreateCase = async ({ params }: { params: { userid: string, queryid: string } }) => {
            ...
            <table className="w-full border">
                <tbody>
                    ...
                    <tr className="border-b">
                        ...
                        <td className="bg-white py-2">{new Date(query.case.createdAt).toLocaleString()}</td>
                    </tr>
                    <tr className="border-b">
                        <td className="bg-gray border-r py-2 pr-2 font-semibold">
                            Query:
                    ...
                    <tr className="border-b">
                        ...
                        <td className="bg-white py-2">{new Date(query.createdAt).toLocaleString()}</td>
                    </tr>
                    ...
                    <tr className="border-b">
                        ...
                        <td>
                            <AnswerQueryComponent queryid={query?.id} userid={params.userid}/>
                        </td>
                    </tr>
